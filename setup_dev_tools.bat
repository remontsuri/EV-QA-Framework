...
set PYTHON_SCRIPTS=/home/user\AppData\Local\Programs\Python\Python312\Scripts
...
/home/user\AppData\Local\Programs\Python\Python312\python.exe -m pip install --upgrade pip
/home/user\AppData\Local\Programs\Python\Python312\python.exe -m pip install jupyter notebook ipykernel
