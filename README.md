...
**Thermal runaway prediction.** Rule-based heuristics (dT/dt, temperature, anomaly score) and ML mode. CRITICAL trigger at >65 °C or heating rate >5 °C/min. Catches overheating before cascade.
